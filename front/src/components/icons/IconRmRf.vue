...
<template>
    ...
    >
        <g>
            <path
                d="M43.6,32.201c-7.168,0-13,5.832-13,13s5.832,13,13,13s13-5.832,13-13S50.769,32.201,43.6,32.201z M43.6,56.201
		c-6.065,0-11-4.935-11-11s4.935-11,11-11s11,4.935,11,11S49.666,56.201,43.6,56.201z"
            />
            <path
                d="M49.6,44.201h-12c-0.552,0-1,0.447-1,1s0.448,1,1,1h12c0.552,0,1-0.447,1-1S50.153,44.201,49.6,44.201z"
            />
            <path
                d="M24.236,29.965c0.326,0.009,0.651,0.018,0.982,0.023C25.674,29.996,26.135,30,26.6,30s0.926-0.004,1.383-0.011
		...
		C24.002,29.96,24.12,29.962,24.236,29.965z"
            />
            <path
                d="M51.6,11.306V9.5V9c0-0.168-0.056-0.319-0.135-0.458C50.343,4.241,41.715,0,26.6,0C11.523,0,2.904,4.22,1.747,8.51
		C1.662,8.657,1.6,8.818,1.6,9v0.5v1.806C4.437,14.267,13.917,17,26.6,17S48.764,14.267,51.6,11.306z"
            />
            <path
                d="M27.755,43.095c0.544-4.111,2.64-7.74,5.698-10.254c-1.359,0.105-2.764,0.188-4.246,0.229
		...
		C26.991,43.111,27.37,43.101,27.755,43.095z"
            />
            <path
                d="M27.65,46.188c-0.351,0.004-0.693,0.012-1.05,0.012c-12.346,0-20.866-2.29-25-5.201v8.201c0,0.162,0.043,0.315,0.117,0.451
