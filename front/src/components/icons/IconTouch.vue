...
<template>
    ...
    >
        <g>
            <path
                d="M44,34c-7.168,0-13,5.832-13,13s5.832,13,13,13s13-5.832,13-13S51.168,34,44,34z M44,58c-6.065,0-11-4.935-11-11
		s4.935-11,11-11s11,4.935,11,11S50.065,58,44,58z"
            />
            <path
                d="M50,46h-5v-5c0-0.553-0.448-1-1-1s-1,0.447-1,1v5h-5c-0.552,0-1,0.447-1,1s0.448,1,1,1h5v5c0,0.553,0.448,1,1,1
		s1-0.447,1-1v-5h5c0.552,0,1-0.447,1-1S50.552,46,50,46z"
            />
            <path
                d="M20,8h9c0.552,0,1-0.447,1-1V1c0-0.553-0.448-1-1-1h-9c-0.552,0-1,0.447-1,1v6C19,7.553,19.448,8,20,8z"
            />
            <path
                d="M13,11h23c0.552,0,1-0.447,1-1V4c0-0.553-0.448-1-1-1h-4c-0.552,0-1,0.447-1,1v5H18V4c0-0.553-0.448-1-1-1h-4
		c-0.552,0-1,0.447-1,1v6C12,10.553,12.448,11,13,11z"
            />
            <path
                d="M28.811,42H10c-0.552,0-1-0.447-1-1s0.448-1,1-1h19c0.206,0,0.387,0.077,0.546,0.184c0.732-1.546,1.7-2.957,2.865-4.184H10
